...
.PHONY: check test topology faq coverage help
...
help:
	...
	@echo "make coverage  - 公理項目ごとの検査被覆マップを再生成（要コミット）"
...
coverage:
	$(PY) scripts/semantic_eval.py gen-coverage --suite semantic-tests/public --out semantic-tests/coverage.md
