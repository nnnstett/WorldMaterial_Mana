...
4. 最大の個体は現界（[E1 現界]）である。現界は宇宙（物質・エネルギーの全体）を内に含む一つの個体であり、意思を持ち、精神エネルギーを使用できる
5. 個体は固有の魂（[E5 魂]）を持つ
...
- **方向**: 変換時にマナがどのエネルギー・物質へ向かうか（変換先）を決める属性。変換先の指定がどこまでの状態に及ぶかは → [I2 共鳴則]
...
マナが現界に現出する瞬間、必ず物理エネルギーまたは物質に変換され、その変換は量を保つ。物質の現出は、既存の物質を押しのけながら形を成す過程（形成）として進む。共鳴を経ない現出に方向づけはない。

**公理**（[凡例](../README.md#役割ラベルの凡例)）:
1. マナ（[E3 マナ]）が現界に現出する瞬間、必ず物理エネルギーまたは物質に変換される。マナのままでは現界に存在できない <a id="i1-現出時変換"></a>
2. マナから物質への変換は、その場を一挙に置き換えるのではなく、形を成していく過程（形成）として進む。生成物は既存の物質と同じ場所を占められず、形成が供給する仕事は既存の物質の押しのけ・圧縮（つながりを保ったままの移動・変形。→ 定義）に要する分に限られ、その供給できる範囲でのみ形成が進む <a id="i1-形成過程"></a>
3. 変換は量を保つ。これは、マナから物質・エネルギーと対の瘴気（マナ変換で必ず生じる副産物。→ [I3 副産則]）が生まれる現出でも、物質・エネルギーと瘴気がマナへ戻る逆向きの変換でも成り立ち、失われた側と生まれた側の総量は等しい（→ [T1 エネルギー保存則]） <a id="i1-量の保存"></a>
4. 共鳴（→ [I2 共鳴則]）を経ない現出（→ [E3 マナ], [T3 自然現化]）では方向づけがなく、確率的である <a id="i1-無方向現出"></a>

**定義**:
- **押しのけ・圧縮**: 既存の物質が、自らのつながり（形）を保ったまま、よける・流れる・縮むこと。水や砂のようにつながりを保とうとしない相手は、生成物を挟んで二つに分かれても、つながりを断たれてはいない
...
- 形成の仕事は押しのけ・圧縮に限られるため、形成が既存の物質を砕く・裂くことはない。つながりを断たなければ進めない場（隙間なく塞がれた場・固体の内部）では、形成は砕くに至らず止まり、その先は現れない
...
精神エネルギーは共鳴により、マナと物質・エネルギーの相互変換を双方向に駆動する。現化の生成物は、駆動した個体が知覚している場に方向の定める状態で現れて裏付けを宿し、裏付けは供給が続く間だけ保たれる。

**公理**（[凡例](../README.md#役割ラベルの凡例)）:
1. 精神エネルギー（[E6 精神エネルギー]）は変換そのものではなく、変換を駆動する <a id="i2-駆動"></a>
2. 変換先（何になるか）は、使用された精神エネルギーの方向が決める（→ [E6 精神エネルギー]）。指定は種類にとどまらず、温度や相（固体・液体・気体の別）、初期の運動までの状態に及び、初期の運動は駆動した個体を基準に定まり、指定がなければ静止して現れる。共鳴の効率は、個体の側では真度・変換先と個体の方向性との整合・魂（[E5 魂]）の形の適合度で決まる（場の側の制約は → [E3 マナ]） <a id="i2-変換先と効率"></a>
3. 共鳴を経た現化の生成物は、駆動した個体が知覚している場（現に感じ取っている場）に現れる。知覚が確かな場ほど精密に、不確かな場ほど大まかにしか現れず、全く感じ取れていない場には現れない <a id="i2-出現位置"></a>
4. 共鳴の働きの大きさは、使用された精神エネルギーの量と強さに応じて増す。量が同じでも、強さが高いほど大きい <a id="i2-強さと働き"></a>
5. 共鳴の相手は向きによって異なる。マナを引き出す向き（現化。→ [T2 共鳴現化]）では**マナ**と、物質をマナへ還す向き（真化。→ [T4 マナ還元]）では**瘴気**（マナ変換の副産物。→ [I3 副産則]）と噛み合う <a id="i2-向きと相手"></a>
6. 真化の向きの共鳴は、瘴気の結合力（瘴気を結合へ向かわせる働き。→ [I3 副産則]）を高める <a id="i2-真化の結合力"></a>
7. 真界寄り（深い真度）ほどマナと、現界寄り（浅い真度）ほど瘴気と共鳴しやすい
8. 駆動するのは、**使用**（意思による方向づけ。→ [E6 精神エネルギー]）された精神エネルギーに限る。使用されない精神エネルギー（意思を持たない個体が帯びる微量分など）はマナと共鳴しない（→ [T3 自然現化]） <a id="i2-使用限定"></a>
9. 共鳴を経てマナから現出した物質・エネルギー（現化の生成物。→ [T2 共鳴現化]）は、駆動した精神エネルギーの影響＝**裏付け**を宿す。裏付けの度合いが、生成物の存在強度（どれだけ消えにくく保たれるかの度合い。→ [I5 継承則]）となる <a id="i2-裏付け"></a>
10. 裏付けの度合いは、精神エネルギーの強さを主要因とし、変換先と方向の整合・魂（[E5 魂]）の形の適合度が副次的に効く。真度・位相は影響しない <a id="i2-裏付けの度合い"></a>
11. 裏付けは、生成した個体が新たな精神エネルギーを使用して支え続ける（供給）間は保たれ、供給が絶えると時とともに弱まる。強い裏付けほど弱まりは遅い <a id="i2-裏付けの維持"></a>
12. 精神エネルギーの属性は、外部の仕組み（術式など。→ [T8 魔術]）を介して、行使中に限り一時的にシフト可能である（→ [E6 精神エネルギー]）。シフトは損失を伴い、シフトを経た精神エネルギーの共鳴の働きはそのぶん小さくなる

**定義**:
- **知覚**: 個体が、その場を現に感じ取っていること。見る・聞く・触れるなど手段は問わない。位置や構造を知識として知ることは知覚ではなく、記憶・知識・推定は出現の場を成立させず、現に感じ取っている場の確かさを補うにとどまる。個体が最も確かに感じ取れるのは、自らの占める場である
...
**関連**:
- → [E2 真界], [E3 マナ], [E5 魂], [E6 精神エネルギー], [I1 変換則], [I3 副産則], [I5 継承則], [T2 共鳴現化], [T4 マナ還元], [T5 存在強度], [T8 魔術]
