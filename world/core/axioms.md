...
11. 方向による変換先の指定は、種類にとどまらず、温度や相（固体・液体・気体の別）、初期の運動までの状態に及ぶ。初期の運動は使用した個体を基準に定まり、指定がなければ静止して現れる <a id="e6-状態指定"></a>
...
- **方向**: 変換時にマナがどのエネルギー・物質へ向かうか（変換先）を決める属性
...
2. マナから物質への変換は、その場を一挙に置き換えるのではなく、形を成していく過程（形成）として進む。生成物は既存の物質と同じ場所を占められず、形成は、既存の物質の押しのけ・圧縮に要する仕事を変換の一部として供給できる範囲でのみ進む <a id="i1-形成過程"></a>
3. 形成は、既存の物質の破壊を経路にしない。水や砂のように押しのけられる相手の中では押しのけて進み、押しのけも圧縮もかなわない場（隙間なく塞がれた場・固体の内部）では、砕くに至らず止まり、その先は現れない <a id="i1-非破壊形成"></a>
4. 変換は量を保つ。これは、マナから物質・エネルギーと対の瘴気（マナ変換で必ず生じる副産物。→ [I3 副産則]）が生まれる現出でも、物質・エネルギーと瘴気がマナへ戻る逆向きの変換でも成り立ち、失われた側と生まれた側の総量は等しい（→ [T1 エネルギー保存則]） <a id="i1-量の保存"></a>
5. 共鳴（→ [I2 共鳴則]）を経ない現出（→ [E3 マナ], [T3 自然現化]）では方向づけがなく、確率的である <a id="i1-無方向現出"></a>
...
3. 共鳴を経た現化の生成物は、駆動した個体が知覚している場（現に感じ取っている場）に現れる。知覚が確かな場ほど精密に、不確かな場ほど大まかにしか現れず、全く感じ取れていない場には現れない。個体にとって最も確かな場は、自らの占める場である <a id="i2-出現位置"></a>
...
**定義**:
- **知覚**: 個体が、その場を現に感じ取っていること。見る・聞く・触れるなど手段は問わない。位置や構造を知識として知ることは知覚ではなく、記憶・知識・推定は出現の場を成立させず、現に感じ取っている場の確かさを補うにとどまる
