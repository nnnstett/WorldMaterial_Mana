...
人・道具・国のようにまとまりを持つものは [E4 個体] の行で引く（「個体」の行は現界自身にも当てはまる。→ [E4 個体#現界個体]）。対角のセルには、同種の他者との関係と自身のふるまいを載せる。還元のように三つの存在が関わる規則は、関与する各行に重ねて載せるため、一つの公理が複数のセルに現れることがある。
...
|---|---|
| 〔経由 X〕 | X を介して関係が及ぶ |
| 〔制約 X〕 | X がその関係の成立・効率・上限を左右する |
| 〔条件 X〕 | X の場合に限って当てはまる |
| （…） | 丸括弧で囲んだ部分は、作用ではない構造関係（存在・所在・保有・対応・接点・経路） |
| ◆… | [世界の概観](#世界の概観)の 5 構造への道しるべ |
| — | この表に載せる規則がない（規則の不在を確定する意味ではない） |

| 関与する存在＼関係先 | 現界 | 真界 | マナ | 個体 | 魂 | 精神エネルギー | 物質 | 物理エネルギー | 瘴気 |
|---|---|---|---|---|---|---|---|---|---|
| **[E1 現界]** | — | （[E2 真界#座標対応] 座標対応） | — | （[E1 現界#個体の場] 個体が存在する場） | （[E5 魂#孔] 現界側の接点） | （[E1 現界#特有の法則] 機能する場） | （[E1 現界] 存在する場） | （[E1 現界] 存在する場） | （[I3 副産則#発生位置] 発生し [I3 副産則#近傍滞留] 滞留する場） |
| **[E2 真界]** | （[E2 真界#座標対応] 座標対応） | — | ◆源 （[E2 真界#マナの場]・[E3 マナ#純粋ポテンシャル] マナが存在する場） | — | （[E5 魂#孔] 真界側の接点） | — | — | — | — |
| **[E3 マナ]** | [I1 変換則#現出時変換] 現出の瞬間に必ず変換される（マナのままでは現界に存在できない） | （[E2 真界#マナの場] 所在） | — | — | ◆現化 （[E5 魂#孔] 通過経路。→ [T2 共鳴現化]） | — | ◆現化 [I1 変換則#現出時変換]・[I1 変換則#量の保存]・[I6 現出則#形成過程]・〔条件 共鳴時〕[I6 現出則#出現位置]・[I6 現出則#状態指定] | ◆現化 [I1 変換則#現出時変換]・[I1 変換則#量の保存]・〔条件 共鳴時〕[I6 現出則#出現位置]・[I6 現出則#状態指定] | ◆現化 [I3 副産則#等量発生]・[I1 変換則#量の保存] |
| **[E4 個体]** | （[E1 現界#個体の場] 現界に存在） | — | [I2 共鳴則#駆動]〔経由 使用した精神エネルギー〕変換を駆動 | [I4 作用則#接続作用]〔経由 使用した精神エネルギー〕他個体（の魂）へ接続し、作用 | （[E4 個体#固有の魂] 固有の魂を保有。原則 1 対 1 は [E5 魂#他魂アクセス]）・[I4 作用則#接続作用]〔経由 使用した精神エネルギー〕他個体の魂へ接続 | ◆駆動 （[E4 個体#帯有と使用] 帯びる・使用する） | [I6 現出則#出現位置]〔制約 知覚が現出の位置・精度を決める〕・[I2 共鳴則#駆動]〔経由 使用した精神エネルギー〕 | [I6 現出則#出現位置]・[I6 現出則#状態指定]〔制約 知覚と個体基準が位置・初期運動を決める〕・[I2 共鳴則#駆動]〔経由 使用した精神エネルギー〕 | [I2 共鳴則#真化の結合力]〔経由 使用した精神エネルギー〕真化を駆動する（→ [T4 マナ還元]） |
...
| **[E6 精神エネルギー]** | — | — | ◆駆動 [I2 共鳴則#駆動] 変換を駆動（マナと噛み合うのは現化の向き。[I2 共鳴則#向きと相手]） | ◆直接作用 [I4 作用則#接続作用] 接続の成立後に作用。読み取り・書き込みの両方向は [I4 作用則#両方向作用] | ◆直接作用 [I4 作用則#接続作用] 他個体の魂へ接続（→ [T6 同調]） | [I4 作用則#位相と阻害]〔制約 接続を阻害〕・[I4 作用則#両方向作用]〔制約 作用を阻害〕 | [I2 共鳴則#変換先と効率] 変換先の決定・[I2 共鳴則#裏付け] 裏付けの付与・[I2 共鳴則#裏付けの維持] 供給による維持・[I6 現出則#状態指定] 状態の指定 | [I2 共鳴則#変換先と効率] 変換先の決定・[I2 共鳴則#裏付け] 裏付けの付与・[I2 共鳴則#裏付けの維持] 供給による維持・[I6 現出則#状態指定] 状態・初期運動の指定 | ◆駆動 [I2 共鳴則#真化の結合力] 真化の向きの共鳴が結合力を高める |
| **物質** | （[E1 現界] 存在） | — | ◆還元 [I3 副産則#結合還元]・[I1 変換則#量の保存] 瘴気と結合してマナへ〔条件 意図的な真化では・[I2 共鳴則#真化の結合力]〕 | [I5 継承則#物理過程不変] 存在強度を継承 | — | — | [I5 継承則#物理過程不変] 存在強度の継承・〔条件 現化時〕[I6 現出則#形成過程] 既存物質の押しのけ・圧縮 | [I5 継承則#物理過程不変] 存在強度の継承 | [I3 副産則#結合還元]〔制約 存在強度が高いほど結合されにくい〕 |
| **物理エネルギー** | （[E1 現界] 存在） | — | ◆還元 [I3 副産則#結合還元]・[I1 変換則#量の保存] 瘴気と結合してマナへ〔条件 意図的な真化では・[I2 共鳴則#真化の結合力]〕 | [I5 継承則#物理過程不変] 存在強度を継承 | — | — | [I5 継承則#物理過程不変] 存在強度の継承 | [I5 継承則#物理過程不変] 存在強度の継承 | [I3 副産則#結合還元]〔制約 存在強度が高いほど結合されにくい〕 |
| **瘴気** | （[I3 副産則#発生位置] 現界で発生・[I3 副産則#近傍滞留] 滞留） | — | ◆還元 [I3 副産則#結合還元]・[I1 変換則#量の保存] | [I3 副産則#結合還元]〔経由 個体を構成する物質・エネルギー〕 | — | — | ◆還元 [I3 副産則#結合還元]・[I3 副産則#優先結合]・[I3 副産則#釣り合い] | ◆還元 [I3 副産則#結合還元]・[I3 副産則#優先結合]・[I3 副産則#釣り合い] | [I3 副産則#近傍滞留]・[I3 副産則#平準化]・[I3 副産則#引き寄せ]・[I3 副産則#不活性化] |
