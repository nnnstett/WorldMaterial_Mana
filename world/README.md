...
| [E4 個体](core/axioms.md#e4-個体) | 境界と持続性を持つ一つのまとまり。ただの寄せ集め（総和）は個体でない。入れ子構造をとる |
...
| [T2 共鳴現化](core/theorems.md#t2-共鳴現化) | 魂を通した心の力がマナと共鳴し、物質やエネルギーが現実に現れる | [E4 個体] + [E5 魂] + [E6 精神エネルギー] + [I1 変換則] + [I2 共鳴則] | [特殊事例: ビッグバン](core/theorems.md#特殊事例-ビッグバン) |
| [T3 自然現化](core/theorems.md#t3-自然現化) | マナが濃すぎる場所で、心の力を介さずマナが現実へ染み出す | [E3 マナ] + [I1 変換則] + [I2 共鳴則] | [危険性](core/theorems.md#危険性) |
| [T4 マナ還元](core/theorems.md#t4-マナ還元) | 瘴気が物質・エネルギーと結びつき、マナへ戻って真界に収まる | [I3 副産則] + [I2 共鳴則] + [E6 精神エネルギー] | [還元判定](core/theorems.md#還元判定)・[優先結合則](core/theorems.md#優先結合則)・[生成物の存続と移動](core/theorems.md#生成物の存続と移動) |
...
E6 精神  │
 エネルギー┘        E3 + I1 + I2 ──→ T3 自然現化 ───→ 危険性
              E6 + I2 + I3 ───────→ T4 マナ還元 ───→ 還元判定 / 優先結合則 / 生成物の存続と移動
