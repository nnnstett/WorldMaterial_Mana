...
flowchart LR
  ...
  P --> B
  Z --> B
  B -->|"◆真化 両者が消えてマナへ（共鳴真化では魂（孔）を通る）"| M
  E -.->|"◆駆動 現化の向き"| M
...
| [T4 共鳴真化](core/theorems.md#t4-共鳴真化) | 心の力が瘴気の結びつきを強め、自然には結合しない相手もマナへ還せる。生じたマナは魂を通って真界へ還る | [E5 魂] + [E6 精神エネルギー] + [E8 瘴気] + [I2 共鳴則] + [I3 副産則] | [還元判定](core/theorems.md#還元判定) |
...
| [Q18 還ったマナの行き先（真界側の位置）](core/open-questions.md#q18-還ったマナの行き先真界側の位置) | 真化の繰り返される土地の真界側で濃度が高まるか、還り先の設計による魔法史・災害の因果づくり |
