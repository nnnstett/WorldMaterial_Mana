...
> **個体の精神エネルギーに駆動されて、真界のマナが魂を通じて現界の物質・エネルギーへ変わる。同時に生じる瘴気が物質・エネルギーをマナへ還し、精神エネルギーは別経路で他個体にも直接作用する世界。**
...
| **◆駆動** | 個体が使用した精神エネルギーが、マナの変換を双方向に駆動する（マナを引き出す向きが現化、物質・エネルギーをマナへ還す向きが真化） | [E4 個体]・[E6 精神エネルギー]・[I2 共鳴則] |
| **◆現化** | マナが魂（孔）を通って現界へ出ると物質またはエネルギーとなり、同時に副産物の瘴気が等量で発生する | [E5 魂]・[I1 変換則]・[I3 副産則]・[I6 現出則] |
| **◆還元** | 瘴気が物質・エネルギーと結合し、両者が消えてマナへ戻る。存在強度（どれだけ消えにくく保たれるかの度合い）が低いものほど結合されやすい | [I3 副産則]・[I1 変換則] |
...
| [T11 瘴気動態](core/theorems.md#t11-瘴気動態) | 瘴気はその場に滞留してゆっくり動き、生成物がいつ・どこまで残るかを決める。運び出しは延命になっても恒久化にならない | [I2 共鳴則] + [I3 副産則] + [I5 継承則] | [活性と不活性](core/theorems.md#活性と不活性)・[生成物の存続と移動](core/theorems.md#生成物の存続と移動) |
...
世界に登場する存在どうしの、どの組に規則があるか（ないか）を引くための一覧である。各行には、その存在が**関与する**関係を、関与の仕方の記号つきで載せる。一つの公理が複数のセルに現れることがある。行を左から右へ読むと、その存在が世界に対して何をするか・何に左右されるかが一通り分かる。

**記号の凡例**:

| 記法 | 意味 |
|---|---|
| リンクのみ | 行の存在が、その公理項目の直接の主体である |
| 〔経由 X〕 | 行の存在が行使者で、X を介して作用が及ぶ |
| 〔制約 X〕 | 行の存在は主体ではないが、X がその関係の成立・効率・上限を左右する |
| 〔条件 X〕 | その記述が X の場合に限って当てはまる |
| （…）セル全体が丸括弧 | 作用ではない構造関係（存在・所在・保有・対応・接点・経路） |
| ◆… | [世界の概観](#世界の概観)の 5 構造への道しるべ |
| — | その方向に関与なし |

| 関与する存在＼関係先 | 現界 | 真界 | マナ | 個体 | 魂 | 精神エネルギー | 物質 | 物理エネルギー | 瘴気 |
|---|---|---|---|---|---|---|---|---|---|
| **[E1 現界]** | — | （[E2 真界#座標対応] 座標対応） | — | （[E1 現界#個体の場] 個体が存在する場） | （[E5 魂#孔] 現界側の接点） | （[E1 現界#特有の法則] 機能する場・[E6 精神エネルギー#未使用の保持] 未使用分が留まる場） | （[E1 現界] 存在する場） | （[E1 現界] 存在する場） | （[I3 副産則#発生位置] 発生し [I3 副産則#近傍滞留] 滞留する場） |
| **[E2 真界]** | （[E2 真界#座標対応] 座標対応） | — | ◆源 （[E2 真界#マナの場]・[E3 マナ#純粋ポテンシャル] マナが存在する場） | — | （[E5 魂#孔] 真界側の接点） | — | — | — | — |
| **[E3 マナ]** | [I1 変換則#現出時変換] 現出の瞬間に必ず変換される（マナのままでは現界に存在できない） | （[E2 真界#マナの場] 所在） | — | — | ◆駆動 （[T2 共鳴現化] 共鳴現化の通過経路〔根拠 [E5 魂#孔]〕） | — | ◆現化 [I1 変換則#現出時変換]・[I1 変換則#量の保存]＋[I6 現出則#形成過程]＋〔条件 共鳴時〕[I6 現出則#出現位置]・[I6 現出則#状態指定] | ◆現化 [I1 変換則#現出時変換]・[I1 変換則#量の保存]＋〔条件 共鳴時〕[I6 現出則#出現位置]・[I6 現出則#状態指定] | ◆現化 [I3 副産則#等量発生]＋[I1 変換則#量の保存] |
| **[E4 個体]** | （[E1 現界#個体の場] 現界に存在） | — | [I2 共鳴則#駆動]〔経由 使用した精神エネルギー・魂〕変換を駆動 | [I4 作用則#接続作用]〔経由 使用した精神エネルギー〕他個体へ接続・作用 | （[E4 個体#固有の魂] 固有の魂を保有。原則 1 対 1 は [E5 魂#他魂アクセス]）＋[I4 作用則#接続作用]〔経由 使用した精神エネルギー〕他個体の魂へ接続 | ◆駆動 （[E4 個体#帯有と使用] 帯びて使用する。未使用分の保持は [E6 精神エネルギー#未使用の保持]） | [I6 現出則#出現位置]〔制約 知覚が現出の位置・精度を決める〕＋[I2 共鳴則#駆動]〔経由 使用した精神エネルギー〕 | [I6 現出則#出現位置]・[I6 現出則#状態指定]〔制約 知覚と個体基準が位置・初期運動を決める〕＋[I2 共鳴則#駆動]〔経由 使用した精神エネルギー〕 | [I2 共鳴則#真化の結合力]〔経由 使用した精神エネルギー〕真化を駆動 |
| **[E5 魂]** | （[E5 魂#孔] 現界との接点） | （[E5 魂#孔] 真界との接点） | [I2 共鳴則#変換先と効率]〔制約 形が共鳴の効率を左右〕＋（[E5 魂#大きさ] 大きさ＝一度に扱えるマナ量の上限） | （[E4 個体#固有の魂] 個体に固有。原則 1 対 1 は [E5 魂#他魂アクセス]） | — | — | — | — | [T4 マナ還元]〔制約 扱う対象に合った形を要する〕 |
| **[E6 精神エネルギー]** | （[E6 精神エネルギー#未使用の保持] 未使用分は個体の内に留まる） | — | ◆駆動 [I2 共鳴則#駆動] 変換を駆動（マナと噛み合うのは現化の向き。[I2 共鳴則#向きと相手]） | ◆直接作用 [I4 作用則#接続作用] 接続の成立後に作用。読み取り・書き込みの両方向は [I4 作用則#両方向作用] | ◆直接作用 [I4 作用則#接続作用] 他個体の魂へ接続（→ [T6 同調]） | [I4 作用則#位相と阻害]〔制約 接続を阻害〕・[I4 作用則#両方向作用]〔制約 作用を阻害〕 | [I2 共鳴則#変換先と効率] 変換先の決定・[I2 共鳴則#裏付け] 裏付けの付与・[I2 共鳴則#裏付けの維持] 供給による維持＋[I6 現出則#状態指定] 状態の指定 | [I2 共鳴則#変換先と効率] 変換先の決定・[I2 共鳴則#裏付け] 裏付けの付与・[I2 共鳴則#裏付けの維持] 供給による維持＋[I6 現出則#状態指定] 状態・初期運動の指定 | ◆駆動 [I2 共鳴則#真化の結合力] 真化の向きの共鳴が結合力を高める |
| **物質** | （[E1 現界] 存在） | — | ◆還元 [I3 副産則#結合還元]＋[I1 変換則#量の保存] 瘴気と結合してマナへ〔条件 意図的な真化では＋[I2 共鳴則#真化の結合力]〕 | （個体の構成要素になりうる）＋[I5 継承則#物理過程不変] 存在強度を継承 | — | — | [I5 継承則#物理過程不変] 存在強度の継承＋〔条件 現化時〕[I6 現出則#形成過程] 既存物質の押しのけ・圧縮 | [I5 継承則#物理過程不変] 存在強度の継承 | [I3 副産則#結合還元]〔制約 存在強度が高いほど結合されにくい〕 |
| **物理エネルギー** | （[E1 現界] 存在） | — | ◆還元 [I3 副産則#結合還元]＋[I1 変換則#量の保存] 瘴気と結合してマナへ〔条件 意図的な真化では＋[I2 共鳴則#真化の結合力]〕 | （個体に取り込まれうる）＋[I5 継承則#物理過程不変] 存在強度を継承 | — | — | [I5 継承則#物理過程不変] 存在強度の継承 | [I5 継承則#物理過程不変] 存在強度の継承 | [I3 副産則#結合還元]〔制約 存在強度が高いほど結合されにくい〕 |
| **瘴気** | （[I3 副産則#発生位置] 現界で発生・[I3 副産則#近傍滞留] 滞留） | — | ◆還元 [I3 副産則#結合還元]＋[I1 変換則#量の保存] | [I3 副産則#結合還元]〔経由 個体を構成する物質・エネルギー〕 | — | — | ◆還元 [I3 副産則#結合還元]・[I3 副産則#優先結合]・[I3 副産則#釣り合い]〔条件 結合力は [I2 共鳴則#真化の結合力] で高められる〕 | ◆還元 [I3 副産則#結合還元]・[I3 副産則#優先結合]・[I3 副産則#釣り合い]〔条件 結合力は [I2 共鳴則#真化の結合力] で高められる〕 | [I3 副産則#近傍滞留]・[I3 副産則#平準化]・[I3 副産則#引き寄せ]・[I3 副産則#不活性化] |

**補足**:

- 物質の現出には形成過程（既存物質の押しのけ・圧縮。[I6 現出則#形成過程]）が働く。物理エネルギーは場所を占めないため形成を要さず、現れたあとは物理法則に従って伝わる。形成過程は物質の変換一般に働くため自然現化でも適用され、位置・状態の指定（[I6 現出則#出現位置]・[I6 現出則#状態指定]）だけが共鳴時に限られる
- 現出の位置と状態は決め手が別である。位置・精度は駆動した個体の知覚が決め、状態（温度・相・初期の運動）は精神エネルギーの方向が決める。感じ取れていない場には、方向をどう指定しても現れない
- 還元は三項関係（物質または物理エネルギー ＋ 瘴気 → マナ）であり、表では物質・物理エネルギー・瘴気の 3 行に現れる
- 個体は入れ子をなし（[E4 個体#入れ子]）、最大の個体は現界である（[E4 個体#現界個体]）。「個体」の行は現界自身にも当てはまる（その最大の帰結が宇宙の誕生。→ [T2 共鳴現化]）
...
[E1 現界#個体の場]: core/axioms.md#e1-個体の場
[E1 現界#特有の法則]: core/axioms.md#e1-特有の法則
[E2 真界#座標対応]: core/axioms.md#e2-座標対応
[E2 真界#マナの場]: core/axioms.md#e2-マナの場
[E3 マナ#純粋ポテンシャル]: core/axioms.md#e3-純粋ポテンシャル
[E4 個体#入れ子]: core/axioms.md#e4-入れ子
[E4 個体#帯有と使用]: core/axioms.md#e4-帯有と使用
[E4 個体#現界個体]: core/axioms.md#e4-現界個体
[E4 個体#固有の魂]: core/axioms.md#e4-固有の魂
[E5 魂#孔]: core/axioms.md#e5-孔
[E5 魂#大きさ]: core/axioms.md#e5-大きさ
[E5 魂#他魂アクセス]: core/axioms.md#e5-他魂アクセス
[E6 精神エネルギー#未使用の保持]: core/axioms.md#e6-未使用の保持
[I1 変換則#現出時変換]: core/axioms.md#i1-現出時変換
[I1 変換則#量の保存]: core/axioms.md#i1-量の保存
[I2 共鳴則#駆動]: core/axioms.md#i2-駆動
[I2 共鳴則#変換先と効率]: core/axioms.md#i2-変換先と効率
[I2 共鳴則#向きと相手]: core/axioms.md#i2-向きと相手
[I2 共鳴則#真化の結合力]: core/axioms.md#i2-真化の結合力
[I2 共鳴則#裏付け]: core/axioms.md#i2-裏付け
[I2 共鳴則#裏付けの維持]: core/axioms.md#i2-裏付けの維持
[I3 副産則#等量発生]: core/axioms.md#i3-等量発生
[I3 副産則#発生位置]: core/axioms.md#i3-発生位置
[I3 副産則#結合還元]: core/axioms.md#i3-結合還元
[I3 副産則#近傍滞留]: core/axioms.md#i3-近傍滞留
[I3 副産則#平準化]: core/axioms.md#i3-平準化
[I3 副産則#引き寄せ]: core/axioms.md#i3-引き寄せ
[I3 副産則#優先結合]: core/axioms.md#i3-優先結合
[I3 副産則#釣り合い]: core/axioms.md#i3-釣り合い
[I3 副産則#不活性化]: core/axioms.md#i3-不活性化
[I4 作用則#接続作用]: core/axioms.md#i4-接続作用
[I4 作用則#両方向作用]: core/axioms.md#i4-両方向作用
[I4 作用則#位相と阻害]: core/axioms.md#i4-位相と阻害
[I5 継承則#物理過程不変]: core/axioms.md#i5-物理過程不変
[I6 現出則#出現位置]: core/axioms.md#i6-出現位置
[I6 現出則#状態指定]: core/axioms.md#i6-状態指定
[I6 現出則#形成過程]: core/axioms.md#i6-形成過程
