...
|---|---|---|---|---|---|---|
| **マナ** | — | — | **◆現化** （[E5 魂] 孔＝共鳴現化時の通過経路） | — | **◆現化** [I1 変換則] 現出時に変換・量保存＋[I6 現出則] 形成過程〔条件 共鳴時のみ〕位置・状態が指定される | **◆現化** [I3 副産則] 等量発生＋[I1 変換則] 量の収支 |
...
| **魂** | [I2 共鳴則]〔制約 形が現化方向の共鳴効率を左右〕＋（[E5 魂] 大きさ＝一度に扱えるマナ量の上限） | （[E5 魂] 個体固有・原則1対1） | — | — | — | [I2 共鳴則]〔制約 形が真化方向の共鳴効率を左右〕 |
| **精神エネルギー** | **◆駆動** [I2 共鳴則] 共鳴して現化を駆動 | **◆直接作用** [I4 作用則] 接続成立後の読み取り・書き込み | **◆直接作用** [I4 作用則] 他個体の魂へ接続 | [I4 作用則]〔制約 作用先個体の精神エネルギーが接続・作用を阻害〕 | [I2 共鳴則] 変換先決定・裏付けの付与／維持＋[I6 現出則] 状態（温度・相・初期の運動）の指定 | **◆駆動** [I2 共鳴則] 真化方向の共鳴・結合力を増強 |
