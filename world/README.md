...
|---|---|---|---|---|---|---|---|
| **[E3 マナ]** | — | — | ◆現化 （[E5 魂#孔] 通過経路。→ [T2 共鳴現化]） | — | ◆現化 [I1 変換則#現出時変換]・[I1 変換則#量の保存]・[I6 現出則#形成過程]・〔条件 共鳴時〕[I6 現出則#出現位置]・[I6 現出則#状態指定] | ◆現化 [I1 変換則#現出時変換]・[I1 変換則#量の保存]・〔条件 共鳴時〕[I6 現出則#出現位置]・[I6 現出則#状態指定] | ◆現化 [I3 副産則#等量発生]・[I1 変換則#量の保存] |
| **[E4 個体]** | [I2 共鳴則#駆動]〔経由 使用した精神エネルギー〕変換を駆動 | [I4 作用則#接続作用]〔経由 使用した精神エネルギー〕他個体（の魂）へ接続し、作用 | （[E4 個体#固有の魂] 固有の魂を保有。原則 1 対 1 は [E5 魂#他魂アクセス]）・[I4 作用則#接続作用]〔経由 使用した精神エネルギー〕他個体の魂へ接続 | ◆駆動 （[E4 個体#帯有と使用] 帯びる・使用する） | [I6 現出則#出現位置]〔制約 知覚が現出の位置・精度を決める〕・[I2 共鳴則#駆動]〔経由 使用した精神エネルギー〕 | [I6 現出則#出現位置]・[I6 現出則#状態指定]〔制約 知覚と個体基準が位置・初期運動を決める〕・[I2 共鳴則#駆動]〔経由 使用した精神エネルギー〕 | [I2 共鳴則#真化の結合力]〔経由 使用した精神エネルギー〕真化を駆動する（→ [T4 マナ還元]） |
| **[E5 魂]** | [I2 共鳴則#変換先と効率]〔制約 形が共鳴の効率を左右〕・（[E5 魂#大きさ] 大きさ＝一度に扱えるマナ量の上限） | （[E4 個体#固有の魂] 個体に固有。原則 1 対 1 は [E5 魂#他魂アクセス]） | — | — | — | — | [T4 マナ還元]〔制約 扱う対象に合った形を要する〕 |
...
| **物質** | ◆還元 [I3 副産則#結合還元]・[I1 変換則#量の保存] 瘴気と結合してマナへ〔条件 意図的な真化では [I2 共鳴則#真化の結合力] が加わる〕 | [I5 継承則#物理過程不変] 存在強度を継承 | — | — | [I5 継承則#物理過程不変] 存在強度の継承・〔条件 現化時〕[I6 現出則#形成過程] 既存物質の押しのけ・圧縮 | [I5 継承則#物理過程不変] 存在強度の継承 | [I3 副産則#結合還元]〔制約 存在強度が高いほど結合されにくい〕 |
| **物理エネルギー** | ◆還元 [I3 副産則#結合還元]・[I1 変換則#量の保存] 瘴気と結合してマナへ〔条件 意図的な真化では [I2 共鳴則#真化の結合力] が加わる〕 | [I5 継承則#物理過程不変] 存在強度を継承 | — | — | [I5 継承則#物理過程不変] 存在強度の継承 | [I5 継承則#物理過程不変] 存在強度の継承 | [I3 副産則#結合還元]〔制約 存在強度が高いほど結合されにくい〕 |
| **瘴気** | ◆還元 [I3 副産則#結合還元]・[I1 変換則#量の保存] | [I3 副産則#結合還元]〔経由 個体を構成する物質・エネルギー〕 | — | — | ◆還元 [I3 副産則#結合還元]・[I3 副産則#優先結合]・[I3 副産則#釣り合い] | ◆還元 [I3 副産則#結合還元]・[I3 副産則#優先結合]・[I3 副産則#釣り合い] | [I3 副産則#近傍滞留]・[I3 副産則#平準化]・[I3 副産則#引き寄せ]・[I3 副産則#不活性化] |
