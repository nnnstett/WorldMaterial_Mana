...
- マナとの相性（波長）が異なる種族たち（→ [種族](races.md)）
...
| [E6 精神エネルギー](core/axioms.md#e6-精神エネルギー) | 波長・強さ・方向の 3 属性を持つエネルギー |
...
| [I2 共鳴則](core/axioms.md#i2-共鳴則) | 精神エネルギーはマナと共鳴し、変換の触媒として機能する |
...
| [T3 自然現化](core/theorems.md#t3-自然現化) | マナが濃すぎる場所で、心の力を介さずマナが現実へ染み出す | [I1 変換則]（[I2 共鳴則] を経由しない経路） | [危険性](core/theorems.md#危険性) |
...
| [T6 同調](core/theorems.md#t6-同調) | 心の力が他個体の魂につながり、情報・感覚・意思を共有する | [E5 魂] + [E6 精神エネルギー] + [I2 共鳴則] + [I4 作用則] | — |
| [T7 魔法](core/theorems.md#t7-魔法) | 自分の心の力で現実を変える術（詳細→[魔法](magic.md)） | [T2 共鳴現化] の応用（自身の精神エネルギー） | — |
| [T8 魔術](core/theorems.md#t8-魔術) | 術式で誰でも同じ現象を起こせるようにした術（詳細→[魔術](spellcraft.md)） | [T2 共鳴現化] の応用（術式を介する） | — |
| [T9 超能力](core/theorems.md#t9-超能力) | マナを介さず、心の力を他者へ直接はたらかせる術（詳細→[超能力](psionics.md)） | [I4 作用則] の応用 | — |
...
| 未解明領域 | 意図された活用例 |
|---|---|
| [Q1 波長を人為的に真界寄りにする方法](core/open-questions.md#q1-波長を人為的に真界寄りにする方法) | 古代技術の再発見、原初返りの人工生成、組織の暗躍 |
...
未解明領域(Q): Q1 波長操作 / Q2 意思を持つ道具 / Q3 真界の内部構造 / Q4 死後の魂 /
...
| ドキュメント | 主な導出元 |
|---|---|
| [魔法](magic.md) | [T7 魔法]、[T2 共鳴現化] |
| [魔術](spellcraft.md) | [T8 魔術]、[T2 共鳴現化] |
...
| [魔法・魔術の歴史](magic-history.md) | [T7 魔法]、[T8 魔術]、[Q1 波長操作] |
