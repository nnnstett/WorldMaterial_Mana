...
人・道具・国のようにまとまりを持つものは [E4 個体] の行で引く（「個体」の行は現界自身にも当てはまる。→ [E4 個体]）。対角のセルには、同種の他者との関係と自身のふるまいを載せる。還元のように三つの存在が関わる規則は、関与する各行に重ねて載せるため、一つの公理が複数のセルに現れることがある。
...
|---|---|---|---|---|---|---|
| **マナ** | — | — | **◆現化** （[E5 魂] 孔＝共鳴現化時の通過経路。→ [T2 共鳴現化]） | — | **◆現化** [I1 変換則] 現出時に変換・量保存＋[I6 現出則] 形成過程〔条件 共鳴時のみ〕位置・状態が指定される | **◆現化** [I3 副産則] 等量発生＋[I1 変換則] 量の収支 |
| **個体** | [I2 共鳴則]〔経由 使用した精神エネルギー・魂〕変換を駆動 | [I4 作用則]〔経由 使用した精神エネルギー〕他個体へ作用 | （[E4 個体]・[E5 魂] 固有の魂を原則1対1で保有）＋[I4 作用則]〔経由 使用した精神エネルギー〕他個体の魂へ接続 | **◆駆動** （[E6 精神エネルギー] 発生・保持・使用） | [I6 現出則]〔制約 知覚が現出位置・精度を決定〕 | [I2 共鳴則]〔経由 使用した精神エネルギー〕真化を駆動 |
| **魂** | [I2 共鳴則]〔制約 形が現化方向の共鳴効率を左右〕＋（[E5 魂] 大きさ＝一度に扱えるマナ量の上限） | （[E5 魂] 個体固有・原則1対1） | — | — | — | [T4 マナ還元]〔制約 形が真化方向の共鳴効率を左右〕 |
| **精神エネルギー** | **◆駆動** [I2 共鳴則] 共鳴して現化を駆動 | **◆直接作用** [I4 作用則] 接続成立後の読み取り・書き込み | **◆直接作用** [I4 作用則] 他個体の魂へ接続（→ [T6 同調]） | [I4 作用則]〔制約 作用先個体の精神エネルギーが接続・作用を阻害〕 | [I2 共鳴則] 変換先決定・裏付けの付与／維持＋[I6 現出則] 状態（温度・相・初期の運動）の指定 | **◆駆動** [I2 共鳴則] 真化方向の共鳴・結合力を増強 |
| **物質・物理エネルギー** | **◆還元** [I3 副産則] 瘴気と結合してマナへ＋[I1 変換則] 量保存〔条件 意図的な真化では＋[I2 共鳴則]〕 | （個体の構成要素になり・取り込まれ得る）＋[I5 継承則] 存在強度を継承 | — | — | [I5 継承則] 通常の物理過程で存在強度を継承＋[I6 現出則]〔条件 現化時〕生成物が既存物質を押しのけ・圧縮 | [I3 副産則]〔制約 存在強度が高いほど結合されにくい〕 |
| **瘴気** | **◆還元** [I3 副産則] 結合還元＋[I1 変換則] 量保存 | [I3 副産則]〔経由 個体の構成物質・物理エネルギー〕 | — | — | **◆還元** [I3 副産則] 結合還元・優先結合・釣り合い〔条件 [I2 共鳴則]で結合力を増強可能〕 | [I3 副産則] 近傍滞留・拡散・平準化・不活性化 |
