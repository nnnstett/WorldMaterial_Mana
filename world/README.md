...
| [I5 継承則](core/axioms.md#i5-継承則) | 存在強度は物理過程を越えてそのまま受け継がれる。変えるのは裏付けの変化だけ |
...
| **[E6 精神エネルギー]** | ◆駆動 [I2 共鳴則] 現化を駆動 | ◆直接作用 [I4 作用則] 読み取り・書き込み〔条件 接続成立後〕 | ◆直接作用 [I4 作用則] 他個体の魂へ接続 | [I4 作用則] 接続先の精神エネルギーが接続・作用を阻害 | [I2 共鳴則] 変換先の決定・裏付けの付与・[I6 現出則] 現出状態の指定 | ◆駆動 [I2 共鳴則] 真化を駆動 |
| **[E7 物質・物理エネルギー]** | ◆真化 [I3 副産則] 瘴気と結合してマナへ | — | — | — | [I5 継承則] 物理過程での存在強度の継承 | [I3 副産則] 存在強度が高いほど結合されにくい |
...
| [T4 真化](core/theorems.md#t4-真化) | 物質・物理エネルギーが瘴気と結びついてマナへ還り、真界に収まる。心の力で狙って起こすこともできる | [E8 瘴気] + [I3 副産則] + [I2 共鳴則] + [E6 精神エネルギー] | [還元判定](core/theorems.md#還元判定)・[優先結合則](core/theorems.md#優先結合則) |
| [T11 瘴気動態](core/theorems.md#t11-瘴気動態) | 瘴気はその場に滞留してゆっくり動き、生成物がいつ・どこまで残るかを決める。運び出しは延命になっても、消えにくさ（存在強度）は変わらない | [E8 瘴気] + [I2 共鳴則] + [I3 副産則] + [I5 継承則] | [活性と不活性](core/theorems.md#活性と不活性)・[生成物の存続と移動](core/theorems.md#生成物の存続と移動) |
| [T5 存在強度](core/theorems.md#t5-存在強度) | あらゆる物質・物理エネルギーが帯びる消えにくさの度合い（存在強度）で、何が消えて何が残るかが決まる | [E7 物質・物理エネルギー] + [I2 共鳴則] + [I3 副産則] + [I5 継承則] | [重要な帰結: ビッグバン由来物質の還元不可能性](core/theorems.md#重要な帰結-ビッグバン由来物質の還元不可能性) |
...
| 定義 | 概要 | 定義対象 |
|---|---|---|
| [T7 魔法](core/theorems.md#t7-魔法) | 自分の心の力で現実を変える術（詳細→[魔法](magic.md)） | [T2 共鳴現化]・[T4 真化]（共鳴真化）の行使のうち、自身の精神エネルギーによるもの |
| [T8 魔術](core/theorems.md#t8-魔術) | 術式で誰でも同じ現象を起こせるようにした術（詳細→[魔術](spellcraft.md)） | [T2 共鳴現化]・[T4 真化]（共鳴真化）の行使のうち、術式を介するもの |
...
| ドキュメント | 主な導出元 |
|---|---|
| [魔法](magic.md) | [T7 魔法]、[T2 共鳴現化]、[T4 真化] |
| [魔術](spellcraft.md) | [T8 魔術]、[T2 共鳴現化]、[T4 真化] |
| [超能力](psionics.md) | [T9 超能力]、[I4 作用則] |
| [アーティファクト](artifacts.md) | [T5 存在強度]、[T10 集合無意識]、[T2 共鳴現化]、[T4 真化] |
| [ダンジョン](dungeons.md) | [T2 共鳴現化]、[T5 存在強度]、[I3 副産則]、[T4 真化]、[T11 瘴気動態]、[E6 精神エネルギー] |
