...
人・道具・国のようにまとまりを持つものは [E4 個体] の行で引く（「個体」の行は現界自身にも当てはまる。→ [E4 個体]）。駆動や他個体への作用は、個体が使用した精神エネルギーが担うため、精神エネルギーの行に載せる。対角のセルには、同種の他者との関係と自身のふるまいを載せる。還元のように三つの存在が関わる規則は、関与する各行に重ねて載せるため、一つの公理が複数のセルに現れることがある。
...
|---|---|---|---|---|---|---|
| **[E3 マナ]** | — | — | ◆現化 （[E5 魂#孔] 通過経路） | — | ◆現化 [I1 変換則]・[I6 現出則] 変換される | ◆現化 [I3 副産則]・[I1 変換則] 変換時の副産物 |
| **[E4 個体]** | — | — | （[E4 個体] 固有の魂を保有。原則 1 対 1） | ◆駆動 [E6 精神エネルギー] 発生・[E4 個体] 帯びる・使用する | [I6 現出則] 知覚が現出の場所・精度を決める | — |
| **[E5 魂]** | [E5 魂] 扱えるマナ量の上限 | （[E4 個体] 個体に固有。原則 1 対 1） | — | — | [E5 魂] 変換先への適性 | [E5 魂] 形が真化の共鳴効率を左右 |
...
| **物質・物理エネルギー** | ◆還元 [I3 副産則] 瘴気と結合してマナへ | — | — | — | [I5 継承則] 物理過程での存在強度の継承 | [I3 副産則] 存在強度が高いほど結合されにくい |
| **瘴気** | ◆還元 [I3 副産則] 物質・物理エネルギーと結合してマナへ | — | — | — | ◆還元 [I3 副産則] 存在強度の低いものと優先的に結合 | [I3 副産則] 滞留・拡散・平準化・不活性化 |
