...
| [I5 保持則](core/axioms.md#i5-保持則) | 存在強度は供給が続く間は保たれ、供給が絶えると弱まる。物理過程ではそのまま受け継がれる |
...
| **[E6 精神エネルギー]** | ◆駆動 [I2 共鳴則] 現化を駆動 | ◆直接作用 [I4 作用則] 読み取り・書き込み〔条件 接続成立後〕 | ◆直接作用 [I4 作用則] 他個体の魂へ接続 | [I4 作用則] 接続先の精神エネルギーが接続・作用を阻害 | [I2 共鳴則] 変換先の決定・裏付けの付与・[I5 保持則] 供給による裏付けの維持・[I6 現出則] 現出状態の指定 | ◆駆動 [I2 共鳴則] 真化を駆動 |
...
| [T5 存在強度](core/theorems.md#t5-存在強度) | あらゆる物質・物理エネルギーが帯びる消えにくさの度合い（存在強度）で、何が消えて何が残るかが決まる | [E7 物質・物理エネルギー] + [I2 共鳴則] + [I3 副産則] + [I5 保持則] | [重要な帰結: ビッグバン由来物質の還元不可能性](core/theorems.md#重要な帰結-ビッグバン由来物質の還元不可能性) |
